...
const ChatScreen: React.FC<ChatScreenProps> = () => {
  ...
  const messages = [
    ...
    {
      id: "3",
      text: "I need some assistance with my account. I need some assistance with my account. I need some assistance with my account.",
      type: "received",
    },
    ...
    >
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View
            style={[
              tailwind`max-w-[75%] p-6 my-2 rounded-10`,
              item.type === "sent"
                ? isDarkMode
